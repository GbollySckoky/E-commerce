  ...
  return (
    <div>
      <div className='pt-[150px] '>
        <h1 className='text-center font-[700] text-3xl text-fadeblue py-[50px]'>FAVOURITES</h1>
        {favourites && favourites.length === 0 
        ? <div className='flex flex-col items-center justify-center h-[49vh] w-[95%] mx-auto text-center'>
              ...
              <div className=' bg-[#d9dcde] px-6 py-3'>
                ...
                <div>
                    {Array.isArray (favourite.color) ? (
                        ...
                        (
                        <div className='py-2'>
                        <p style={{ backgroundColor: favourite.color, width: '10px', 
